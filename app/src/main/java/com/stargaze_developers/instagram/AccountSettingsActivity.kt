...
class AccountSettingsActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        // --------------------Tick Button in Edit Profile-----------------
        save_infor_profile_btn.setOnClickListener {
            if(checker == "clicked")   //-------------works only if change image is clicked ------------------
            {
    ...
    private fun updateUserInfoOnly()
    {
        ...
        when {
            TextUtils.isEmpty(full_name_profile_frag.text.toString()) -> {
                Toast.makeText( this, "Please provide the full name", Toast.LENGTH_LONG).show()
            }
            ...
            bio_profile_frag.text.toString() == "" -> {
                Toast.makeText( this, "Please provide your bio", Toast.LENGTH_LONG).show()
            }
            else -> {
