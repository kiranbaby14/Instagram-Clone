...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(fullName: String, userName: String, email: String, progressDialog: ProgressDialog)
    {
        ...
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/instagram-clone-e97a7.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=8dfef0d4-0edb-4d32-b1b2-1f43a47f0a68"
