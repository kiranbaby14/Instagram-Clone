...
import com.stargaze_developers.instagram.Adapter.CommentAdapter
import com.stargaze_developers.instagram.Model.Comment
...
//        getPostImage()
        ...
        post_comment.setOnClickListener(View.OnClickListener {
            ...
            {
                Toast.makeText(this@CommentsActivity, "Write your comments", Toast.LENGTH_LONG).show()
            }
            else
            {
                addComment()
