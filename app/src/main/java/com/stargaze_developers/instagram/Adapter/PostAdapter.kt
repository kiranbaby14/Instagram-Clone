...
import com.stargaze_developers.instagram.CommentsActivity
import com.stargaze_developers.instagram.Fragments.PostDetailsFragment
     ...
     private val mPost: List<Post>) : RecyclerView.Adapter<PostAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        Picasso.get().load(post.getPostimage()).into(holder.postImage)   //---------------------------- retrieving images from firebase to POST----------------
